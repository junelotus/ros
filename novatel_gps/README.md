...
packages are available for all of them.  To install them, first install ROS.

Then build it from source using [catkin_tools](https://catkin-tools.readthedocs.io/en/latest/installing.html):
...
catkin_make
cd src
git clone https://e.coding.net/nullmax/drivers.git
...
3. ### `novatel_common`
    This repository provides various utility packages supported for dependencies of 
    novatel_gps_driver.
